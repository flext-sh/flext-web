...
def AppStatus(*args: Any, **kwargs: Any) -> FlextWebAppStatus:
...
def WebError(*args: Any, **kwargs: Any) -> FlextWebError:
    """Legacy alias for FlextWebError."""
    _deprecation_warning("WebError", "FlextWebError")
    return FlextWebError(*args, **kwargs)


def WebValidationError(*args: Any, **kwargs: Any) -> FlextWebValidationError:
...
def WebConfigurationError(*args: Any, **kwargs: Any) -> FlextWebConfigurationError:
...
def WebConnectionError(*args: Any, **kwargs: Any) -> FlextWebConnectionError:
...
def WebAuthenticationError(*args: Any, **kwargs: Any) -> FlextWebAuthenticationError:
...
def WebTemplateError(*args: Any, **kwargs: Any) -> FlextWebTemplateError:
...
def WebRoutingError(*args: Any, **kwargs: Any) -> FlextWebRoutingError:
...
def WebSessionError(*args: Any, **kwargs: Any) -> FlextWebSessionError:
...
def WebMiddlewareError(*args: Any, **kwargs: Any) -> FlextWebMiddlewareError:
