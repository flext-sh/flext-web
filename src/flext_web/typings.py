    ...
    def configure_web_types_system(
        ...
        *,
        ...
        try:
            ...
            return r[FlextWebTypes.Web.TypesConfig].fail(
                f"Failed to configure web types system: {exc}",
            )

    @classmethod
    def web_types_system_config(cls) -> p.Result[FlextWebTypes.Web.TypesConfig]:
