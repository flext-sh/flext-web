...
This module contains the core domain entities and value objects for the FLEXT Web
Interface, implementing Domain-Driven Design patterns with Clean Architecture boundaries.
...
All entities follow flext-core patterns for consistency and enterprise-grade
reliability.
"""
