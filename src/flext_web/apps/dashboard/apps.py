...
This module configures the dashboard application for the FLEXT Meltano Enterprise
...
class DashboardConfig(AppConfig):
    """Django application configuration for the FLEXT Dashboard.

    Configures the dashboard application that provides real-time monitoring,
    pipeline management, and analytics visualization for the FLEXT Meltano
    Enterprise platform.
