...
class TestWebHandlers:
    ...
    def test_handle_app_start(self) -> None:
        ...
        # Create an app first
        app = FlextWebApp(id="app_test-app", name="test-app", host="localhost", port=8080, status=FlextWebAppStatus.STOPPED)
    ...
    def test_handle_app_stop(self) -> None:
        ...
        app = FlextWebApp(id="app_test-app", name="test-app", host="localhost", port=8080, status=FlextWebAppStatus.RUNNING)
...
class TestWebResponseHandler:
    ...
    def setup_flask_context(self) -> None:
    ...
    def test_create_success_response(self) -> None:
        ...
        response = WebResponseHandler.create_success_response("Operation successful", {"id": "123"})
    ...
    def test_create_error_response_with_details(self) -> None:
        ...
        error_details = {"code": "VALIDATION_ERROR", "field": "name"}
    ...
    def test_response_structure_consistency(self) -> None:
        ...
        success_response = WebResponseHandler.create_success_response("Success", {"test": True})
        error_response = WebResponseHandler.create_error_response("Error", 400, {"code": "TEST"})
    ...
    def test_response_data_types(self) -> None:
        ...
        for data in data_types:
            response = WebResponseHandler.create_success_response("Test", data)
...
class TestHandlerIntegration:
    ...
    def test_error_handling_patterns(self) -> None:
        ...
        app = FlextWebApp(id="app_error-test", name="error-test", status=FlextWebAppStatus.RUNNING)
        result = WebHandlers.handle_app_start(app)
