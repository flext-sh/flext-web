...
class TestFlextWebFields:
    ...
    def test_http_status_field_creation(self) -> None:
        ...
        u.Tests.Matchers.that(response.is_success is True, eq=True)
    ...
    def test_http_status_field_bad_request(self) -> None:
        ...
        u.Tests.Matchers.that(response.status_code, eq=400)
        u.Tests.Matchers.that(response.is_error is True, eq=True)
    ...
    def test_http_status_field_not_found(self) -> None:
        ...
        u.Tests.Matchers.that(response.status_code, eq=404)
        u.Tests.Matchers.that(response.is_error is True, eq=True)
    ...
    def test_http_status_field_server_error(self) -> None:
        ...
        u.Tests.Matchers.that(response.status_code, eq=500)
        u.Tests.Matchers.that(response.is_error is True, eq=True)
    ...
    def test_field_constraints(self) -> None:
        ...
        u.Tests.Matchers.that(test_model.url, eq="http://localhost:8080")
        u.Tests.Matchers.that(test_model.method, eq="GET")
    ...
    def test_field_descriptions(self) -> None:
        ...
        u.Tests.Matchers.that(host_model is not None, eq=True)
        u.Tests.Matchers.that(port_model is not None, eq=True)
    ...
    def test_http_status_field_with_kwargs(self) -> None:
        ...
        u.Tests.Matchers.that(response_model.status_code, eq=200)
        u.Tests.Matchers.that(response_model.is_success is True, eq=True)
    ...
    def test_field_creation_with_kwargs(self) -> None:
        ...
        u.Tests.Matchers.that(request_model.url, eq="http://localhost:8080")
        u.Tests.Matchers.that(request_model.method, eq="POST")
        u.Tests.Matchers.that(
            request_model.headers["Content-Type"], eq="application/json"
        )
    ...
    def test_http_status_field_factory_methods(self) -> None:
        ...
        for status_code in status_codes:
            ...
            u.Tests.Matchers.that(response_model.status_code, eq=status_code)
            u.Tests.Matchers.that(isinstance(response_model, m.Web.Response), eq=True)

    def test_field_validation_integration(self) -> None:
        """Test field validation integration."""
        model = FlextWebSettings()
        u.Tests.Matchers.that(model.host, eq=c.Web.WebDefaults.HOST)
        u.Tests.Matchers.that(model.port, eq=c.Web.WebDefaults.PORT)
